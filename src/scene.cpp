...
void Scene::createLights() {
    for (int i = 0; i < primitives.size(); i++) {
        const Object& object = objects[primitives[i].objID];
        if (materials[object.materialid].type == emitting) {
...
{
    cout << "Loading Model " << modelPath << " ..." << "useVertexNormal£º " << useVertexNormal << endl;
